<div class='modal-dialog' id="FT">
  <div class='modal-content'>
    ...
    <button type='button' class='btn btn-default btn-sm btn-primary' onclick="Simpan('simpanMerk',$('#FA').serialize())"><span class='glyphicon glyphicon-save'></span> Simpan</button>
